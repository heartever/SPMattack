...
void default_do_page_fault(struct pt_regs *regs, unsigned long error_code)
{
...
do_page_fault_handler_t do_page_fault_handler = my_do_page_fault;//default_do_page_fault;
